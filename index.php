  ...
  <main id="main">
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <?php
          $q="SELECT * FROM `cows` WHERE `status`=1 order by date desc";
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch text-center" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <img src="<?= $row['img'] ?>" class="rounded img-thumbnail mx-auto d-block" alt="product">
              </a>                            
            </div>
          </div>
          <?php } ?>

  </div></div></section><!-- End Services Section -->
